...
function numberOfCharacters(string) {
  ...
  for (var i=0; i < string.length; i++){
    ...
    //validar que ya no exista en el objeto
    ...
    //si no existe, contar cuantos hay en el string
    if(encontrado === false){
      ...
      //agregar al objeto el caracter como key y la cantidad como value
...
function asAmirror(str) {
  ...
  for (var i=0; i < separado.length; i++){
    separado[i]= separado[i].split('').reverse().join('');
  }
  str = separado.join(' ');
